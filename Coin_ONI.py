...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 13:17:59 2023
...
beads_image_path=r'/Volumes/Candace A/Candace/20230418_BiotinylatedNanobody_eGFP_PSD95/beads_2023-04-18_15-34-53/'


# Root path - where to save

root_path="/Users/candace/Library/CloudStorage/OneDrive-UniversityofEdinburgh/Ruth&Remi Data/RJ_RO_Beads_Images_Results/RJ_RO_beads/pos_4/"
# These are the names of the files to image:

green_image="Left.tif"
red_image="Right.tif"
...
for i in range(1,2):
    for k in range(1,2):
        pathlist.append(root_path) #+ str(i) +str(k)+"_")
...
def rotate(matrix):
    ...
    if rows % 2 == 1:
        mid_row = matrix[rows//2]
        for j in range(cols // 2):
            mid_row[j], mid_row[cols-j-1] = mid_row[cols-j-1], mid_row[j]
    return matrix
