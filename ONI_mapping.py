...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  3 10:55:16 2023
...
beads_file=r'/Volumes/Candace A/CandaceImagingData/20230328_230328_CTA_BiotinHaloPulldown/Beads/pos_1/230328_CTA_BiotinHaloPulldown_Beads_posXY1_channels_t0_posZ0.tif'
root_path = r'/Volumes/Candace A/CandaceImagingData/20230224_PSD93_488_PSD95_SiR/Laserpowerlower-1/'

# Filename of images to map:
Filename='Left_max.tif'

# Paths to mapy
for i in range(1,9):
    pathlist.append(root_path + "pos_"+str(i)+"/")
...
greenSlice = (img[140,0:684,0:428]/255).astype(np.uint8)
redSlice = (img[140,0:684,428:856]/255).astype(np.uint8)
...
for path in pathlist:
   ...
   # greenSlice2 = (img[135,0:684,0:428]/255).astype(np.uint8)
    #redSlice2 = (img[26,0:684,428:856]/255).astype(np.uint8)
    
    newresult=ird.transform_img_dict(img_to_convert, result, bgval=None, order=1, invert=True).astype('uint16')
